...
(function() {
  const TOAST_CONFIG = {
    ...
    error: {
      icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="16" height="16"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>`,
      label: 'Error',
    },
    info: {
      icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="16" height="16"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>`,
      label: 'Info',
    },
    warning: {
      icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="16" height="16"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`,
      label: 'Warning',
    },
  };
  ...
  function showToast(message, type = 'info') {
    ...
    // Apply type class and trigger animation
    toast.className = `toast ${type} show`;

    // Click-to-dismiss on close button
...
(function initWalletModal() {
  ...
  function bindOpeners() {
    ...
    // Hero "Claim Airdrop" (keep backward compat if the ID exists)
